...
nq_setTokenPositionPointer: unmangled func (l: OocListener, tokenPosPointer: Int*, lineNoPointer: Int*) {
    l tokenPosPointer = tokenPosPointer
    l lineNoPointer = tokenPosPointer
}
...
nq_onCoverProto:      unmangled func (l: OocListener) { l onCoverProto() }
...
nq_onOperatorAbstract: unmangled func (l: OocListener) { l onOperatorAbstract() }
...
nq_onStringLiteralStart: unmangled func(l: OocListener) { l onStringLiteralStart() }
nq_onStringInterpolation: unmangled func(l: OocListener, object: Object) { l onStringInterpolation(object) }
nq_onStringTextChunk: unmangled func(l: OocListener, text: CString) { l onStringTextChunk(text) }
